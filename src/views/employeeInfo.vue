<template>
  <div style="padding: 10px;width: 100%" >
    ...
    <div style="margin: 10px;text-align: center" class="button-container">
      <el-input v-model="search" placeholder="请输入工作人员姓名" style="width:200px" clearable/>
    ...
    <el-table :data="tableData" border stripe  style="width: 100%" >
      ...
      <el-table-column label="工作人员" width="100">
        <template #default="scope">
      ...
      <el-form :model="form" label-width="120px">
        <el-form-item label="头像">
          <el-upload
              ...
              action="http://localhost:8081/file/upload/employee"
...
export default {
  ...
  exp(){
      window.open("http://localhost:8081/employee/export")
  },
    handleEdit(row){
